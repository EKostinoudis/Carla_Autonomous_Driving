...
class PPOTorchLearnerPretrainedL1Loss(PPOLearner, TorchLearner):
    ''' 
    Chaned version of the PPOTorchLearner, removed the KL loss and added a new
    L1 loss from the frozen pretrained model.
    '''
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.pt_l1_coeff = 1.
        self.pt_l1_coeff_decay = 0.9995
    ...
    def compute_loss_for_module(self, *, module_id, hps, batch, fwd_out):
        ...
        self.register_metrics(
            module_id,
            {
                ...
                ENTROPY_KEY: mean_entropy,
                'pretrained_l1_loss': possibly_masked_mean(l1_loss),
                'pt_l1_coeff': self.pt_l1_coeff,
            },
        )
        # Return the total loss.
        return total_loss
