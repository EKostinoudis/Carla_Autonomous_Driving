'''
from https://github.com/carla-simulator/leaderboard
https://github.com/carla-simulator/leaderboard/blob/111a48f9099c08a2f1068ee8aea2ad56ce52ef9d/leaderboard/envs/sensor_interface.py
'''
import copy
import logging
import numpy as np
